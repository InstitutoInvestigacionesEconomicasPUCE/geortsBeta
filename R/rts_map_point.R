...
rts_map_point = function(TS,positions.TS, RTS, positions.RTS ,weights.TS=NULL,type = c("2D","3D","2D+3D","2D-dynamic","3D-dynamic"), k=1, fpss=5, windowsize = c(400, 650) ,save.plot=TRUE,file.name="plot", ...){
  # clean Time Series
